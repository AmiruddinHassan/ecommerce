...
Route::namespace ('Admin')->group(function(){
    Route::get(admin/login', 'LogininController@showLoginForm')->name('admin.login');
    ...
    Route::namespace('Admin')->group(function(){
        Route::group([middleware' => ['role:admin|superadmin|clerk, guard:employee']], function(){
            ...
            Route::namespace('Orders')->group(function(){
                ...
                Route::get('orders/{id}/invoice', 'OrderController@generatInvoice')->name('order.invoice.generate');
            });
            Route::resource('addresses', 'Addresses\AddressController');
            Route::resource('countries', 'CountryController');
            Route::resource('countries.province', 'Country\ProvinceController');
            Route::resource('countries.province.city', 'Cities\CityController');
            Route::resource('couriers', 'Couriers\CourierController');
            Route::resource('attributes', 'Attributes\AttributeController');
            Route::resource('attributes.value', 'Attributes\AttributeValueController');
        ...
        Route::group(['middleware' => ['role:admin|superadmin, guard:employee']],function(){
            ...
            Route::put('employees/{id}/profile', EmployeeController@geUpdateProfile)->name('employee.profile.update');
...
Route::namespece('Front')->group(function(){
    ...
    Route::group(['middleware' => ['auth', 'web']],function(){
        ...
        Route::namespace('Addresses')->group(function(){
            ...
            Route::resources('state.city', 'StateCityController');
        });
        ...
        Route::resources('customer.address', 'CustomerAddressesController');
    });
